...
const AnalyticsDashboard = ({avgVisitorsPerDay, topCountries, timeseriesPageviews, amtVisitorsToday}: AnalyticsDashboardProps) => {
  return (
    <div className="flex flex-col gap-6">
        ...
        <Card className="flex flex-cols sm:grid grid-cols-4 gap-6">
            <h2 className="w-full text-dark-tremor-content-strong text-center sm:left-left font-semibold text-x1">
